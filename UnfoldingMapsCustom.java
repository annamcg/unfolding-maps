...
/** HelloWorld
  ...
  * Date: July 17, 2015
  * */
public class UnfoldingMapsCustom extends PApplet
{
	...
	public void setup() {
	    ...
	    map1.zoomAndPanTo(zoomLevel, new Location(55.7f, 37.6f));
		...
		// The next line zooms in and centers the map at 
	    // 32.9 (latitude) and -117.2 (longitude)
	    map2.zoomAndPanTo(zoomLevel, new Location(40.7f, -74.0f));
